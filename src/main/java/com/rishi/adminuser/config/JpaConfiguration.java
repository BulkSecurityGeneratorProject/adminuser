...
@Configuration
@EnableJpaRepositories(basePackages = "com.rishi.adminuser.repositories",
...
public class JpaConfiguration {
	...
	private final static Logger log = LoggerFactory.getLogger(JpaConfiguration.class);
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.rishi.adminuser.entity" });
